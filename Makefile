out=$(PROGNAME)
sources=$(PROGNAME).c vendor/mpc/mpc.c vendor/mini-gmp/mini-gmp.c lisp.c lval.c symbol.c builtin.c
headers=vendor/mpc/mpc.h vendor/mini-gmp/mini-gmp.h lisp.h lval.h symbol.h builtin.h
