...
/** llex transforms the input into a list of tokens.
...
/** llex_from calls llex_lex with the content of the file input. */
...
#define ltok_print(token) ltok_print_to(token, stdout)
...
#define ltok_print_all(tokens) ltok_print_all_to(tokens, stdout)
